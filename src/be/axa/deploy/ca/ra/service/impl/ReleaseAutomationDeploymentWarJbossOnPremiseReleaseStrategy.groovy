 ...
 */
class ReleaseAutomationDeploymentWarJbossOnPremiseReleaseStrategy extends AbstractReleaseAutomationDeploymentStrategy implements IDeploymentStrategy, Serializable {


    ReleaseAutomationDeploymentWarJbossOnPremiseReleaseStrategy(IBinariesRepository repository, Object properties) {
