 ...
 */
class ReleaseAutomationDeploymentZipJvmDevelopmentStrategy extends AbstractReleaseAutomationDeploymentStrategy implements IDeploymentStrategy, Serializable {

    ReleaseAutomationDeploymentZipJvmDevelopmentStrategy(IBinariesRepository repository, properties) {
    ...
    protected String getDeploymentTemplate() {
        return "WebLogic12_single_EAR_IT"
    }
