 ...
 */
class ReleaseAutomationNoDeploymentDevelopmentStrategy extends AbstractReleaseAutomationDeploymentStrategy implements IDeploymentStrategy, Serializable {

    ReleaseAutomationNoDeploymentDevelopmentStrategy(IBinariesRepository repository, properties) {
