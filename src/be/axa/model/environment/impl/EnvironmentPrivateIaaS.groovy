 ...
 */
enum EnvironmentPrivateIaaS implements Environment {

    IT("it1","IT", AtsArtifactoryRepository.binaryStore, AtsArtifactoryRepository.propertiesBinaryStore, "true", ""),
    ...
    EnvironmentPrivateIaaS(String tokenNameValue, String environmentNameValue, String artefactBinaryStoreName, String propertiesBinaryStoreName, String checkDeploymentWindow, String deploymentStageToPerform) {
