 ...
 */
enum EnvironmentPureApp implements Environment {

    IT1("it1","IT", AtsArtifactoryRepository.binaryStore, AtsArtifactoryRepository.propertiesBinaryStore, "false", "Post-Deployment"),
    IT2("it2","IT2", AtsArtifactoryRepository.binaryStore, AtsArtifactoryRepository.propertiesBinaryStore, "false", "Post-Deployment"),
    FT1("ft1","FT", AtsArtifactoryRepository.atsBinaryStore, AtsArtifactoryRepository.atsPropertiesBinaryStore, "true", "None"),
    FT2("ft2","FT2", AtsArtifactoryRepository.atsBinaryStore, AtsArtifactoryRepository.atsPropertiesBinaryStore, "true", "None"),
    ...
    EnvironmentPureApp(String tokenNameValue, String environmentNameValue, String artefactBinaryStoreName, String propertiesBinaryStoreName, String checkDeploymentWindow, String deploymentStageToPerform) {
